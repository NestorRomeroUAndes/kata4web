...
SECRET_KEY = '9km2+^fen7nt%v5p9+297kz4hrxga0&9&irm3o+%ydfzpq(fr#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# AWS S3 Credentials
# AWS_ACCESS_KEY_ID = '9km2+^fen7nt%v5p9+297kz4hrxga0&9&irm3o+%ydfzpq(fr#'
# AWS_SECRET_ACCESS_KEY = '9km2+^fen7nt%v5p9+297kz4hrxga0&9&irm3o+%ydfzpq(fr#'
